    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] px-4">
      <div className="w-full max-w-md bg-[var(--surface)] rounded-2xl border border-[var(--border)] p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[var(--text-muted)] mt-1">Enter your email to receive a reset link</p>
        </div>
        ...
        {sent ? (
          <div className="text-center">
            ...
            <Link href="/login" className="text-[var(--accent)] font-medium text-sm hover:underline">Back to Sign In</Link>
          </div>
        ) : (
          <>
            {error && (
